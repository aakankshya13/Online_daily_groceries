...
public class AllCategory extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        allCategoryModelList.add(new AllCategoryModel(1, R.drawable.ic_home_fish));
        allCategoryModelList.add(new AllCategoryModel(2, R.drawable.home_dairy));
        allCategoryModelList.add(new AllCategoryModel(3, R.drawable.home_dessert));
        allCategoryModelList.add(new AllCategoryModel(4, R.drawable.home_drink));
        allCategoryModelList.add(new AllCategoryModel(5, R.drawable.home_egg));
        allCategoryModelList.add(new AllCategoryModel(6, R.drawable.home_fruits));
        allCategoryModelList.add(new AllCategoryModel(7, R.drawable.home_meat));
        allCategoryModelList.add(new AllCategoryModel(8, R.drawable.home_spices));
